...
public class cm3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (start && once)
        {
            ...
            if (r == 0) { x = -100f+-2.7f; x2 = -100f + -0.9f; }
            else if (r == 1) { x = -100f + -0.9f; x2 = -100f + .9f; }
            else if (r == 2) { x = -100f + .9f; x2 = -100f + 2.7f; }
            else if (r == 3) { x = -100f + -2.7f; x2 = -100f + .9f; }
            else if (r == 4) { x = -100f + -0.9f; x2 = -100f + 2.7f; }
            else { x = -100f + -2.7f; x2 = -100f + 2.7f; }
