...
public class chiknm3 : MonoBehaviour
{
    public float x;
    public float x2;
    bool once = true;
    ...
    void Update()
    {
        ...
        if (start && once)
        {
            ...
            if (r == 0) { x = -200f + -2.7f; x2 = -200f + -0.9f; }
            else if (r == 1) { x = -200f + -0.9f; x2 = -200f + .9f; }
            else if (r == 2) { x = -200f + .9f; x2 = -200f + 2.7f; }
            else if (r == 3) { x = -200f + -2.7f; x2 = -200f + .9f; }
            else if (r == 4) { x = -200f + -0.9f; x2 = -200f + 2.7f; }
            else { x = -200f + -2.7f; x2 = -200f + 2.7f; }
